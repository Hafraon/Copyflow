...
interface ManualFormEnhancedProps {
  onContentGenerated?: (content: GeneratedContent) => void;
}

export function ManualFormEnhanced({ onContentGenerated }: ManualFormEnhancedProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Add language and platform to form data
      const requestData = {
        ...formData,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Writing Style */}
      <div>
        <Label htmlFor="style">{t('form.style.label')}</Label>
